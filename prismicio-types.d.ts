...
interface SkateboardDocumentData {
  ...
  /**
   * Cutomizer Link field in *Skateboard*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: skateboard.cutomizer_link
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/fields/link
   */
  cutomizer_link: prismic.LinkField<
    string,
    string,
    unknown,
    prismic.FieldState,
...
export interface ProductGridSliceDefaultPrimaryProductItem {
  ...
  skateboard: ContentRelationshipFieldWithData<
    [{ id: "skateboard"; fields: ["name", "image", "price", "cutomizer_link"] }]
  >;
}
